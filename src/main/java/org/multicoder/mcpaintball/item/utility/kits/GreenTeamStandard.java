...
public class GreenTeamStandard extends Item
{

    public GreenTeamStandard()
    {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced)
    {
        ...
        {
            pTooltipComponents.add(Component.translatable("text.mcpaintball.click_standard").withStyle(ChatFormatting.BOLD));
        }
        else
        {
