...
public class GreenPaintballHeavyArrowEntity extends AbstractArrow
{

    public GreenPaintballHeavyArrowEntity(EntityType<? extends Entity> p_36858_, Level p_36859_) {super((EntityType<? extends AbstractArrow>) p_36858_, p_36859_);}

    public GreenPaintballHeavyArrowEntity(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {super((EntityType<? extends AbstractArrow>) entityinit.GREEN_PAINTBALL_HEAVY.get(), p_36862_, p_36863_, p_36864_,p_36861_);}

    public GreenPaintballHeavyArrowEntity(Level p_36866_, LivingEntity p_36867_) {super((EntityType<? extends AbstractArrow>) entityinit.GREEN_PAINTBALL_HEAVY.get(), p_36867_,p_36866_);}
